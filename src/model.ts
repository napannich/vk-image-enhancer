 ...
 */
export function predictEnhancements(hist: ChannelHistogram): EnhancementParams {
 ...
 */
export function mergeWithUserParams(
  ml: EnhancementParams,
  user: Partial<EnhancementParams>,
): EnhancementParams {
  return {
